# Apostila: Segurança em Sistemas de Informação

Este repositório contém o material didático da disciplina de **Segurança em Sistemas de Informação** do curso de Bacharelado em Sistemas de Informação. O material está organizado em módulos, cobrindo desde os fundamentos até práticas avançadas de defesa e gestão.
...
*   **Exercícios:** [Lista de Exercícios do Módulo 01](./exercicios/lista-01.md)

### Módulo 02: Criptografia Aplicada (Em breve)
*   **Capítulo 4:** Fundamentos de Criptografia
*   **Capítulo 5:** Criptografia Simétrica
*   **Capítulo 6:** Criptografia Assimétrica
*   **Capítulo 7:** Certificados Digitais e ICP-Brasil
*   **Capítulo 8:** Aplicações Práticas de Criptografia

### Módulo 03: Controle de Acesso e Identidade (Em breve)
*   **Capítulo 9:** Identidade Digital e Autenticação
...
*   **Exercícios:** [Lista de Exercícios do Módulo 04](./exercicios/lista-04.md)
...
1.  **Navegação:** Você pode ler os capítulos diretamente no GitHub clicando nos links acima. O conteúdo está formatado em Markdown para facilitar a leitura em qualquer dispositivo.
2.  **Exercícios:** Ao final de cada módulo, utilize a lista de exercícios para fixação do conteúdo.
3.  **Contribuições:** Sugestões de melhorias, correções de erros de digitação ou novos exemplos práticos são bem-vindos.

## ⚖️ Licença

Este material está licenciado sob a [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)](./LICENSE.md).
